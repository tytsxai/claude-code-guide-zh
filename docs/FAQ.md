...
### 译文多久更新一次？
[GitHub Actions](../.github/workflows/sync.yml) 检查上游；只要上游有新提交，就自动翻译变更部分并提交。也可手动触发或本地运行。

> 注：上游自 2026-02-14（`712c838`）起停止更新，译文已同步到该提交，**每小时定时任务已于 2026-07-20 暂停**，目前仅保留手动触发。
